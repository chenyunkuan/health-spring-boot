...
public final class HttpClientUtil {
    ...
    private Object setPostRequest(String targetUrl,Map params,String responseType,OutputStream outputStream)throws Exception{
        ...
        try{
            ...
            //连接超时,单位毫秒
            connectionManager.getParams().setConnectionTimeout(500);
            //读取超时,单位毫秒
            ...
            if(sendStatus == HttpStatus.SC_OK){
                logger.info("HttpClientUtil.setPostRequest()-responseType:{}",responseType);
                ...
                logger.info("HttpClientUtil.setPostRequest() failed,responseStatus is {}",sendStatus);
            }
        }catch(Exception e){
